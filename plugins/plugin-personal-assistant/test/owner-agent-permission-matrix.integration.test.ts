 ...
 * nine states the issue enumerates. The matrix itself is credential-free: it
 * uses PGlite, synthetic roles, and locally persisted connector grants. Live
 * provider and native-device validation remains in the dedicated live lanes.
 *
 ...
 *
 * See `docs/owner-agent-validation-matrix.md` for the separate live-provider
 * prerequisites and evidence matrix.
 */
...
describe("LifeOps OWNER vs AGENT permission matrix (#8833)", () => {
  beforeAll(async () => {
