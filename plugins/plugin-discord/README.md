...
# Maximum addressed bot-authored messages handled per channel within one minute.
# A human message resets the chain. Set 0 for unlimited (default: 3).
DISCORD_BOT_REPLY_CHAIN_LIMIT=3
