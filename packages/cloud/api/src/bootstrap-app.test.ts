...
test("only model-dispatch surfaces bypass the legacy Railway Redis guard", () => {
  for (const path of [
    ...
    "/api/v1/apps/app-a/chat",
    "/api/agents/agent-a/a2a",
    "/api/agents/agent-a/mcp",
  ...
  for (const path of [
    "/api/v1/chatty",
    "/api/v1/apps/app-a",
    "/api/v1/apps/app-a/chat/history",
    "/api/v1/generate-prompts/history",
    "/api/agents/agent-a/card",
    "/api/v1/agents/agent-a/message",
    "/api/internal/discord/eliza-app/messages",
    "/api/webhooks/twilio/org-a",
    "/api/webhooks/blooio/org-a",
    "/api/webhooks/whatsapp/org-a",
    "/api/webhooks/bluebubbles",
    "/api/v1/telegram/webhook/org-a",
    "/api/webhooks/twilio/org-a/status",
