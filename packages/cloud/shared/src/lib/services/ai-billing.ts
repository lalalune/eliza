...
import {
  AFFILIATE_PAYOUT_CONTRACT_VERSION,
} from "./affiliate-payout-outbox";
...
async function resolveBillableAffiliate(
  ...
  if (Object.prototype.hasOwnProperty.call(context, "affiliateAttribution")) {
...
function contextWithReservationAffiliate(
  ...
  if (
    reservation &&
    Object.prototype.hasOwnProperty.call(reservation, "affiliateAttribution")
  ) {
    return {
      ...context,
