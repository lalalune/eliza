...
| [`research/11-agentic-parent-suite.md`](research/11-agentic-parent-suite.md) | Agentic parent-suite audit: existing LifeOps substrate, missing scheduling/household/commerce primitives, world-traveling co-parent persona, connector plan, phased implementation, and real E2E matrix. |
