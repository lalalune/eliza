...
| [`research/10-projects-apps-consolidation.md`](research/10-projects-apps-consolidation.md) | Consolidate "My Apps" into Projects: Project as the one durable object, "app = published project" (Cloud-gated publish, per-project publish page with URL/monetization/analytics), agent publish/manage verbs, phased plan. |
| [`research/11-giraffe-agentic-parent-suite.md`](research/11-giraffe-agentic-parent-suite.md) | Giraffe parent-agent suite audit: existing LifeOps substrate, missing scheduling/household/commerce primitives, world-traveling co-parent persona, connector plan, phased implementation, and real E2E matrix. |
