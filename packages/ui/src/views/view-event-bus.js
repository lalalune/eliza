 ...
 */
export function emitViewEvent(type, payload = {}, sourceViewId) {
    const event = {
        type,
        payload,
        sourceViewId,
 ...
 */
export function onViewEvent(type, handler) {
