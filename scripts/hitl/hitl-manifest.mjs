...
export const HITL_DECISION_POINTS = [
  ...
  {
    id: "lifeops-matrix-keyless",
    group: "lifeops-live",
    label: "9-state OWNER/AGENT permission matrix (keyless)",
    mark: "auto",
    why: "machine-decided by owner-agent-permission-matrix.integration.test.ts in the default integration lane",
    suites: [],
    issues: [11632],
  },
  {
