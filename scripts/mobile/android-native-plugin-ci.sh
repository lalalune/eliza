#!/usr/bin/env bash
# Runs Android native-plugin instrumentation after the emulator is ready. A
# standalone Bash boundary preserves Gradle continuations, command substitutions,
# captured exit status, and pipefail across the entire device proof.
